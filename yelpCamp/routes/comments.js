...
router.get("/campgrounds/:id/comments/:comment_id/edit",middleware.checkcomm,function(req,res){
...
router.put("/campgrounds/:id/comments/:comment_id",middleware.checkcomm,function(req,res){
...
router.delete("/campgrounds/:id/comments/:comment_id",middleware.checkcomm,function(req,res){
